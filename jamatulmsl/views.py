...
class savepersondetails(LoginRequiredMixin, APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            return render(request, 'registrationform.html', {'context': condata['ids'] }, status=status.HTTP_201_CREATED)
...
class viewResume(LoginRequiredMixin, APIView):
    ...
    def post(self, request):
        ...
        user_profile = gatepass.objects.filter(vehicle_no=vehicle_no)
